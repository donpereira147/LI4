    ...
    class UtilizadorDAO
    {
        ...
        public void adicionaPesquisa(int id, string pesquisa)
        {
            using (SqlConnection conn = new SqlConnection("Trusted_Connection=true;server =NOMORESEGFAULTS\\SQLEXPRESS;database=MnhamMnham"))
            {
                ...
                SqlCommand inserePesquisa = new SqlCommand("INSERT INTO MnhamMnham.dbo.Pesquisa (id_utilizador, pesquisa) " +
        ...
        public bool registaUtilizador(string n, string e, string p)
        {
            ...
            using (SqlConnection conn = new SqlConnection("Trusted_Connection=true;server =NOMORESEGFAULTS\\SQLEXPRESS;database=MnhamMnham"))
            {
                ...
                if (exists == false)
                {
                    ...
                    SqlCommand registaUtilizador = new SqlCommand("INSERT INTO MnhamMnham.dbo.Utilizador ( nome, email, password) " +
