...
namespace LoginRegisto
{
    ...
    {
        string site, codigo_postal, designacao, rede_social;
        int telefone, NIF;
        float classificacao;
        HashSet<Refeicao> refeicoes;
        public Estabelecimento(string s, string cp, string des, string rs, int t, int n, float cl, HashSet<Refeicao> r)
        {
            site = s;
            codigo_postal = cp;
            designacao = des;
